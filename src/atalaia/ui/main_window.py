...
_NOMES_PAGINA = ["PDV", "Produtos", "Clientes", "Fornecedores", "Entradas",
                 "Orçamentos", "Relatórios", "Configurações"]
...
class MainWindow(QMainWindow):
    ...
    def _criar_paginas(self) -> None:
        self._stack.addWidget(_placeholder("🖥️ PDV\nEm desenvolvimento"))             # 0
        self._stack.addWidget(TelaProdutos())                                           # 1
        self._stack.addWidget(TelaClientes())                                           # 2
        self._stack.addWidget(TelaFornecedores())                                       # 3
        self._stack.addWidget(TelaEntradas())                                           # 4
        self._stack.addWidget(TelaOrcamentos())                                          # 5
        self._stack.addWidget(_placeholder("📊 Relatórios\nEm desenvolvimento"))        # 6
        self._stack.addWidget(_placeholder("⚙️ Configurações\nEm desenvolvimento"))     # 7
